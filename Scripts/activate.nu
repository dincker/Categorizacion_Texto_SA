...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\farayal\Sonda S.A\clastering_text\Web\Clasificacion'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\farayal\Sonda S.A\clastering_text\Web\Clasificacion\Scripts\deactivate.nu'
